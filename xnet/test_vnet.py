...
test_img_list = glob("/datasets/polyps_dataset/test/images/*.jpg")
test_mask_list = glob("/datasets/polyps_dataset/test/masks/*.jpg")
...
G = models.vnet_2d((SIZE_1, SIZE_2, 3), filter_num=[16, 32, 64, 128, 256], n_labels=2,
                      res_num_ini=1, res_num_max=3,
                      activation='PReLU', output_activation='Softmax',
                      batch_norm=True, pool=False, unpool=False, name='vnet')
G.load_weights('/unet/vnet_polyps_noaugm_retry_model/vnet_polyps_noaugm_retry_weights')

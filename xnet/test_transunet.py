...
test_img_list = glob("/datasets/cells_dataset/test/images/*.bmp")
test_mask_list = glob("/datasets/cells_dataset/test/masks/*.bmp")
...
G = models.transunet_2d((SIZE_1, SIZE_2, 3), filter_num=[64, 128, 256, 512], n_labels=2, stack_num_down=2, stack_num_up=2,
...
G.load_weights('/unet/transunet_cells_augm_model/transunet_cells_augm_weights')

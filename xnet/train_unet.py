...
def train(epochs, batch_size, model_save_dir):
    ...
    G = models.unet_2d((None, None, 3), [64, 128, 256, 512, 1024], n_labels=2,
    ...
    for e in range(1, epochs+1):
        ...
        if(res > max_val_dice):
            max_val_dice = res
            G.save(model_save_dir + 'unet_polyps_augm')
            G.save_weights(model_save_dir + 'unet_polyps_augm_weights')
            print('New Val_Dice HighScore',res)            
            
model_save_dir = '/unet/unet_polyps_augm_model/'

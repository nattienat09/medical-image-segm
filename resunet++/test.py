...
test_img_list = glob("/datasets/segpc/test/images/*")
test_mask_list = glob("/datasets/segpc/test/masks/*")
...
G = arch.build_model()
G.load_weights('/resunetplusplus/resunetpp_dsb_augm_model/resunetpp_dsb_augm_weights')
